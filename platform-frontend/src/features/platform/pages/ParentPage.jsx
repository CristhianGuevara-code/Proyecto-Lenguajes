...
export const ParentPage = () => {
  return (
    <div className="min-h-screen p-6 font-sans text-gray-800">
      ...
      <div className="mb-10">
        <h2 className="text-2xl font-semibold text-platform-darkblue mb-4">
          Asignaturas a las que se ha accedido recientemente:
        </h2>
        <div className="grid md:grid-cols-3 gap-4">
          {["Matemáticas", "Español", "Estudios Sociales"].map((subject, index) => (
            <Link to="/assignments" key={index} className="block">
              <div
                className="bg-white rounded-xl shadow-md p-4 border-l-4 border-blue-300 hover:shadow-xl transition cursor-pointer"
              >
